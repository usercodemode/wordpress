...
// Adding css and javascript file (View your website source code from browser to check below style and script is included)
...
// Second method to add javascript
function myJsCode(){
    echo '<script>alert("Books Manager: myJSCode Test");</script>';
}
